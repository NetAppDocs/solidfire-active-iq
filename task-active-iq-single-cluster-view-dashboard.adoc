...
* Total Min Configured IOPS
+
NOTE: Beginning with Element 12.8 clusters, an additional field *IOPS Rebalancing* is provided. This field's value is either Enabled or Disabled. This field is used to balance slices according to the true load rather than the minimum IOPS settings.
