...
== Events
On the *Events* page of the *Reporting* drop-down menu for a selected cluster, you can select tabs to view information about key events and gcEvents that have occurred on the cluster. This information can be filtered and exported to a CSV file.
